...
function buildContext(code, diagnostics) {
...
async function callGemini(system, userContent, opts) {
 ...
 */
async function explainError(code, diagnostics) {
 ...
 */
async function generateHint(code, diagnostics, level, previousHints) {
    const specificity = {
 ...
 */
async function generatePatch(code, diagnostics, previousHints) {
